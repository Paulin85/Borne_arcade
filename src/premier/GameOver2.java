...
public class GameOver2 extends MapGameState {
	 ...
	 public int getID() {
	  ...
	  public void init(GameContainer container, StateBasedGame game) throws SlickException {
	    ...
	    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
	        ...
	        g.drawString("GAME OVER! " + Joueur.pseudo_joueur + " WIN !", 600,100);
	        ...
	        g.drawString("Try again? (Y: Bouton 1/ N: Bouton 2 )", 600, 460);
	        g.drawString("LeaderBoard (L : Bouton 3)", 600, 480);
